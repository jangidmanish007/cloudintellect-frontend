                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 max-w-full sm:max-w-[480px] w-full">
                  {stats.map((stat, i) => (
                    <motion.div
                      ...
                      className="bg-[#0000003D] rounded-[14px] p-4 backdrop-blur-sm sm:p-5 md:p-6 flex flex-col gap-1.5 sm:gap-2 border border-[#FFFFFF1A] transition-all duration-300 hover:bg-[rgba(0,0,0,0.15)] hover:border-white/10"
                    >
